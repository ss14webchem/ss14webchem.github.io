...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.isBordered === void 0 && $$bindings.isBordered && isBordered !== void 0) $$bindings.isBordered(isBordered);
  if ($$props.isCapsule === void 0 && $$bindings.isCapsule && isCapsule !== void 0) $$bindings.isCapsule(isCapsule);
  if ($$props.isGrouped === void 0 && $$bindings.isGrouped && isGrouped !== void 0) $$bindings.isGrouped(isGrouped);
  if ($$props.isBlock === void 0 && $$bindings.isBlock && isBlock !== void 0) $$bindings.isBlock(isBlock);
  if ($$props.isLink === void 0 && $$bindings.isLink && isLink !== void 0) $$bindings.isLink(isLink);
  if ($$props.isBlank === void 0 && $$bindings.isBlank && isBlank !== void 0) $$bindings.isBlank(isBlank);
  if ($$props.isDisabled === void 0 && $$bindings.isDisabled && isDisabled !== void 0) $$bindings.isDisabled(isDisabled);
  if ($$props.role === void 0 && $$bindings.role && role !== void 0) $$bindings.role(role);
  if ($$props.isCircle === void 0 && $$bindings.isCircle && isCircle !== void 0) $$bindings.isCircle(isCircle);
  ...
  if ($$props.ariaSelected === void 0 && $$bindings.ariaSelected && ariaSelected !== void 0) $$bindings.ariaSelected(ariaSelected);
  ...
  return ` ${type === "faux" ? `<div class="${escape(null_to_empty(klasses), true) + " svelte-jwfndu"}">${slots.default ? slots.default({}) : ``}</div>` : `<button${spread(
    [
      { type: escape_attribute_value(type) },
      { class: escape_attribute_value(klasses) },
      { role: escape_attribute_value(role) },
      {
        "aria-selected": escape_attribute_value(aSelected)
      },
      {
        "aria-controls": escape_attribute_value(ariaControls)
      },
      {
        "tab-index": escape_attribute_value(tIndex)
      },
      { disabled: isDisabled || null },
      escape_object($$restProps)
    ],
    { classes: "svelte-jwfndu" }
  )}>${slots.default ? slots.default({}) : ``}</button>`}`;
});
const css$1$6 = {
  code: ".btn-group.svelte-2dcpuq{display:inline-flex;flex-direction:row}",
  map: '{"version":3,"file":"ButtonGroup.svelte","sources":["ButtonGroup.svelte"],"sourcesContent":["<style>\\n/**\\n * Button Groups. See also button-core.css which has btn-grouped which needs to be\\n * applied to the buttons that are projected within a button group.\\n */\\n.btn-group {\\n  display: inline-flex;\\n  flex-direction: row;\\n}\\n\\n</style>\\n\\n<script>\\n  export let ariaLabel = \\"\\";\\n  export let css = \\"\\";\\n  let klasses = [\\"btn-group\\", css ? `${css}` : \\"\\"];\\n  klasses = klasses.filter((klass) => klass.length);\\n  klasses = klasses.join(\\" \\");\\n<\/script>\\n\\n<div class={klasses} role=\\"group\\" aria-label={ariaLabel} on:click>\\n  <slot />\\n</div>\\n"],"names":[],"mappings":"AAKA,wBAAW,CACT,OAAO,CAAE,WAAW,CACpB,cAAc,CAAE,GAClB"}'
};
const ButtonGroup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { ariaLabel = "" } = $$props;
  let { css: css2 = "" } = $$props;
  let klasses = ["btn-group", css2 ? `${css2}` : ""];
  klasses = klasses.filter((klass) => klass.length);
  klasses = klasses.join(" ");
  if ($$props.ariaLabel === void 0 && $$bindings.ariaLabel && ariaLabel !== void 0) $$bindings.ariaLabel(ariaLabel);
  if ($$props.css === void 0 && $$bindings.css && css2 !== void 0) $$bindings.css(css2);
  $$result.css.add(css$1$6);
  return `<div class="${escape(null_to_empty(klasses), true) + " svelte-2dcpuq"}" role="group"${add_attribute("aria-label", ariaLabel, 0)}>${slots.default ? slots.default({}) : ``}</div>`;
});
const css$1$5 = {
...
const Chem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div>${validate_component(Card, "Card").$$render(
    ...
    {
      default: () => {
        return `<b><div class="p16 title svelte-k37cu1">${escape(title)}</div></b> <div class="mix svelte-k37cu1">${!minTemp ? `<p class="mixtext svelte-k37cu1" data-svelte-h="svelte-1jfzhr0">Mix</p>` : ``} ${minTemp ? `<p>Mix at ${escape(minTemp)}K</p>` : ``}</div> <div class="split svelte-k37cu1"><div class="p16 list svelte-k37cu1"><b data-svelte-h="svelte-n73bga"><div class="p16 tag svelte-k37cu1">Reactants</div></b> ${each(react, (reactant) => {
          return `<div class="p16 item svelte-k37cu1">${escape(reactant[0])} [${escape(reactant[1].amount)}]
                    </div>`;
        })}</div> ${products ? `<div class="p16 list svelte-k37cu1"><b data-svelte-h="svelte-1q4z2mk"><div class="p16 item svelte-k37cu1">Products</div></b> ${each(product, (prod) => {
          return `<div class="p16 item svelte-k37cu1">${escape(prod[0])} [${escape(prod[1])}]
                        </div>`;
        })}</div>` : ``}</div> <div class="p16 hidden svelte-k37cu1" data-svelte-h="svelte-4d2cty">🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀🧑‍🚀</div>`;
      }
    }
  )} </div>`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="root"><div class="container svelte-vvoifg">${validate_component(Header, "Header").$$render($$result, { isHeaderContentEnd: true }, {}, {
      default: () => {
    ...
    })} <div class="container buttons svelte-vvoifg">${validate_component(ButtonGroup, "ButtonGroup").$$render(
      $$result,
      {
    ...
    )}</div> <div class="container card-grid svelte-vvoifg">${function(__value) {
